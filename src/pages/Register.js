...
export const Register = () => {
  ...
  async function handleRegister(event) {
    ...
    const response = await fetch("https://json-server-for-data.onrender.com/register", requestOptions);
