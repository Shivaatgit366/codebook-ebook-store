...
export const Login = () => {
  ...
  async function handleLogin(event) {
    ...
    const response = await fetch("https://json-server-for-data.onrender.com/login", requestOptions);
